...
extern NSString * const FSURLValueTransformerName;

/// The name for a value transformer that converts strings into NSUUIDs and back.
extern NSString * const FSUUIDValueTransformerName;
...
/// proper boolean.
extern NSString * const FSBooleanValueTransformerName;

@interface NSValueTransformer (FSPredefinedTransformerAdditions)
...
/// representation.
///
///   NSValueTransformer *valueTransformer = [NSValueTransformer fs_valueMappingTransformerWithDictionary:@{
///     @"foo": @(EnumDataTypeFoo),
///     @"bar": @(EnumDataTypeBar),
...
+ (NSValueTransformer<FSTransformerErrorHandling> *)fs_valueMappingTransformerWithDictionary:(NSDictionary *)dictionary defaultValue:(id)defaultValue reverseDefaultValue:(id)reverseDefaultValue;

/// Returns a value transformer created by calling
/// `+fs_valueMappingTransformerWithDictionary:defaultValue:reverseDefaultValue:`
/// with a default value of `nil` and a reverse default value of `nil`.
+ (NSValueTransformer<FSTransformerErrorHandling> *)fs_valueMappingTransformerWithDictionary:(NSDictionary *)dictionary;
...
/// Returns a value transformer created by calling
/// `+fs_dateTransformerWithDateFormat:calendar:locale:timeZone:defaultDate:`
