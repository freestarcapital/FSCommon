...
typedef enum {
     ...
     */
    fs_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    fs_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    fs_propertyMemoryManagementPolicyCopy
} fs_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #fs_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    fs_propertyMemoryManagementPolicy memoryManagementPolicy;
