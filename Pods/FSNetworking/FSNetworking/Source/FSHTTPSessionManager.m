...
@interface FSHTTPSessionManager ()
           ...
           sessionConfiguration:(NSURLSessionConfiguration *)configuration
{
    ...
    self.requestSerializer = [FSHTTPRequestSerializer serializer];
...
- (void)setRequestSerializer:(FSHTTPRequestSerializer <FSURLRequestSerialization> *)requestSerializer {
    NSParameterAssert(requestSerializer);
    
    _requestSerializer = requestSerializer;
}

- (void)setResponseSerializer:(FSHTTPResponseSerializer <FSURLResponseSerialization> *)responseSerializer {
...
- (NSURLSessionDataTask *)POST:(NSString *)URLString
     ...
     constructingBodyWithBlock:(nullable void (^)(id<FSMultipartFormData> _Nonnull))block
...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    ...
    self.requestSerializer = [decoder decodeObjectOfClass:[FSHTTPRequestSerializer class] forKey:NSStringFromSelector(@selector(requestSerializer))];
    self.responseSerializer = [decoder decodeObjectOfClass:[FSHTTPResponseSerializer class] forKey:NSStringFromSelector(@selector(responseSerializer))];
...
- (instancetype)copyWithZone:(NSZone *)zone {
    FSHTTPSessionManager *HTTPClient = [[[self class] allocWithZone:zone] initWithBaseURL:self.baseURL sessionConfiguration:self.session.configuration];
